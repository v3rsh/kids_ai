...
- [ ] В чате модерации на новую заявку: блок «Быстрые команды», кнопка «📄 Карточка» открывает карточку с фото; при настроенном `EXPRESS_DEEPLINK_TEMPLATE` — кнопка «📄 Карточка в очереди» (deeplink в DM).
