...
├── states.py            # FSM-состояния: UserIntake, ModeratorFlow / ModeratorAction, JuryFlow / JuryTaskFlow
...
Заведены пять классов состояний — анкета участника, контекст ветки
модератора (меню + диалоговые подсказки) и контекст ветки жюри
(меню + прохождение задачи):
