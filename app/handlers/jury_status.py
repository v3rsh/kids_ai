"""
Handler ``/jury_status`` (Wave 2 / ветка C).

Показывает судье **общий прогресс** по его задачам (§27.4 второй пункт,
§35.4): сколько раундов он отправил, сколько в работе (есть черновики),
сколько ещё не открывал.
