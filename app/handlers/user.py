...
ABOUT_TEXT = (
    ...
    "сотрудников Билайн. а также детей, чьими усыновителями, опекунами," 
    "попечителями или иными законными представителями являются сотрудники"
    " Билайн.\n\n"
    "**Мы предлагаем детям раскрыть тему:**\n"
    "«Что помогает мне быть в безопасности в сети»\n\n"
...
DATES_TEXT = (
    ...
    "- 1–15 июня — приём работ\n"
    "- 16–28 июня — работа жюри и народное голосование\n"
    "- 29 июня — объявление итогов"
)
...
EXAMPLES_TEXT = (
    ...
    "**Пример промпта для ИИ-трека**\n\n"
    "*Нарисуй детскую иллюстрацию на тему безопасного поведения "
    "в интернете.*\n\n"
    "*- Главный герой: мальчик в наушниках, который играет в Minecraft.*\n"
    "*- Ситуация: в игровом чате ему пишет незнакомый игрок.*\n"
    "*- Опасность или проблема: незнакомец обещает подарить редкий "
    "предмет, если мальчик отправит код из СМС.*\n"
    "*- Кто помогает: мама стоит рядом и объясняет, что коды и пароли "
    "никому нельзя отправлять.*\n"
    "*- Главная мысль картинки: если в игре просят код, пароль или "
    "личные данные, нужно сказать взрослому.*\n"
    "*- Стиль: яркая мультяшная иллюстрация.*\n"
    "*- Настроение: доброе и понятное. Без страшных сцен.*\n\n"
    "**Пример промпта для трека «От руки к ИИ»**\n\n"
    "*Переосмысли исходный детский рисунок как более детальную "
    "иллюстрацию.*\n\n"
    "*На исходном рисунке изображён маленький дракон, который сидит "
    "рядом с ноутбуком и не пускает к нему злые вирусы.*\n\n"
    "*- Главная идея рисунка: интернет можно защищать, как сказочный "
    "замок.*\n"
    "*- Важно сохранить: дракона-защитника, ноутбук, вирусы вокруг, "
    "ощущение, что герой помогает ребёнку.*\n"
    "*- Можно усилить: сделать дракона более выразительным, добавить "
    "светящийся защитный круг вокруг ноутбука, показать вирусы как "
    "смешных злых персонажей.*\n"
    "*- Не менять: дракон должен остаться добрым защитником, а не "
    "страшным монстром.*\n"
    "*- Стиль финальной версии: яркая мультяшная иллюстрация.*\n"
    "*- Настроение: доброе, сказочное, немного приключенческое.*\n\n"
    "*Сохрани связь с оригинальным детским рисунком. Финальная версия "
    "должна выглядеть как развитие идеи ребёнка, а не как полностью "
    "новая работа.*"
)
...
from handlers import user_fix as _user_fix  # noqa: E402, F401
