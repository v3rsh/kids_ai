...
async def build_shortlist(
    *,
    ...
    """Сформировать шорт-лист по итогам всех пулов (§35.5).

    Число пулов = ``len(services.pools.all_pools())`` (после Wave 0
    replay 2026-05-21 это 9: 3 трека × 3 категории; до — 12). Хардкода
